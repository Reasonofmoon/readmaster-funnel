...
| 행사 | 공개 페이지 | 저장소 |
|---|---|---|
| 설명회 | `funnel.html`, `book.html` | Apps Script `1Km37p3DZSj-0Ma-c2hQeDCnn8ZKndwu3vl0-VWqMp-3Xxjjrx9APWrEU` → `📋 설명회 예약` |
| 간담회 | `briefing.html`, `briefing-curriculum.html` | 별도 Apps Script → `ReadMaster 간담회 예약` |

두 흐름은 각각의 Apps Script와 스프레드시트를 사용합니다. 설명회용 백엔드를 간담회 페이지에 연결하지 않습니다.
